...
parser.add_argument('--pretrained', default=False, type=str2bool,
                    help="Load ImageNet V1 pretrained weights for the backbone.")
...
parser.add_argument("--action_size", type=int, default=-1,
                    help="Override action vector size. Use -1 for dataset default.")
parser.add_argument("--action_indices", type=str, default="",
                    help="Comma-separated indices of action parameters to use (e.g., '0,1,4' for azimuth and distance in MAPS). "
                         "Empty string means use all parameters. Presets: 'camera', 'light', 'background', 'azimuth', 'distance', etc.")
parser.add_argument("--action_exclude_indices", type=str, default="",
                    help="Comma-separated indices of action parameters to exclude (e.g., '2,3' to exclude roll in MAPS). "
                         "Used only if action_indices is not specified.")
