...
from utils.datasets import Toys4kDataset, CO3D, MVImgNet, MAPSDataset, MAPSInstanceSplitDataset, ImageNetPerClassTarDataset
...
DATASETS = {
    ...
    "MAPSInstanceSplitDataset": {
                'class': MAPSInstanceSplitDataset,
                'size': 50000,
                'img_size': (224, 224),
                'rgb_mean': (0.485, 0.456, 0.406),
                'rgb_std': (0.229, 0.224, 0.225),
    ...
    "ImageNetPerClassTarDataset": {
                'class': ImageNetPerClassTarDataset,
                'action_size': 16,
            }
    }
