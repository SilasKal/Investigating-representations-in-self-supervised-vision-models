"""
Code from https://github.com/tonylins/simclr-converter.
"""
import os
...
def load_simclr():
    ...
    path_weigths = r"C:\Users\silas\PycharmProjects\SimClr_MT\pretrained\weights\resnet50_1x\resnet50_1x.pth"
    assert os.path.exists(path_weigths), f"Weights path not found: {path_weigths}"
    # path_weigths = os.path.join(path_dir, 'weights', 'resnet50-1x.pth')
